<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:39:"./application/admin\view\nav_index.html";i:1503471579;s:42:"./application/admin\view\index_header.html";i:1493194503;s:42:"./application/admin\view\index_footer.html";i:1529044280;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
<meta charset="utf-8">
    ...
    <form method="post">
      <table width="100%">
        ...
        <tr>
          ...
          <td align="center"><a target="_blank" href="__INDEX__/cat/<?php echo $vo['id']; ?>.html"><?php if($vo['level'] != 0): ?>└─ <?php endif; ?><?php echo $vo['name']; ?></a></td>     
          <td align="center"><?php if($vo['type'] == 1): ?>PC站<?php else: ?>WAP站<?php endif; ?></td>
          <td align="center"><?php echo $vo['identity']; ?></td>
          <td align="center">
          ...
          <td align="center">
            <a class="layui-btn layui-btn-mini layui-btn-warm" href="<?php echo url('nav/edit',array('id'=>$vo['id'])); ?>">修改</a> <a class="layui-btn layui-btn-mini layui-btn-danger del_btn" member-id="<?php echo $vo['id']; ?>" title="删除" nickname="<?php echo $vo['name']; ?>">删除</a>
          </td>
        </tr>
...
function changeshow(o){
  ...
  $.ajax({
	  ...
	  dataType:"json",
      data:{change:change},
	  url:"<?php echo url('nav/changeshow'); ?>",
...
layui.use('form',function(){
  ...
  jq('.del_btn').click(function(){
    ...
    layer.confirm('确定删除【'+name+'】?', function(index){
      ...
      jq.post('<?php echo url("nav/dels"); ?>',{'id':id},function(data){
        if(data.code == 200){
          layer.close(loading);

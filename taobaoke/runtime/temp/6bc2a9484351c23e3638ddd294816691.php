<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:34:"./template/default/live_index.html";i:1503410512;s:36:"./template/default/index_header.html";i:1506439004;s:37:"./template/default/public_gradeh.html";i:1490864914;s:36:"./template/default/index_footer.html";i:1505706092;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>优惠直播 - <?php echo config('web.WEB_AUT'); ?></title>
    ...
    <?php if(is_array($GoodsList) || $GoodsList instanceof \think\Collection || $GoodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $GoodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <li>
        <div class="goods-main">
          <div class="pic">
            <a href="<?php echo $vo['clickUrl']; ?>" target="_blank">
              <img class="lazy" data-original="<?php echo $vo['pic']; ?>" alt="<?php echo $vo['title']; ?>">                                           
            </a>
            <?php echo newicon($vo['startTime']); ?>
          </div>
          <div class="quan">
            <a href="<?php echo $vo['clickUrl']; ?>" target="_blank" rel="nofollow">

<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:33:"./template/default/index_cat.html";i:1502530238;s:36:"./template/default/index_header.html";i:1506439004;s:37:"./template/default/public_gradeh.html";i:1490864914;s:36:"./template/default/public_goods.html";i:1506701012;s:36:"./template/default/index_footer.html";i:1505706092;}*/ ?>
  ...
  <div class="sort">
    <div class="layui-main">
      <div class="sort-main">
        ...
        <a href="<?php echo url('cat/'.$cid,array('sort'=>'new')); ?>" <?php if($sort == 'new'): ?>class="active"<?php endif; ?>>最新<i class="layui-icon" style="vertical-align: -2px;">&#xe625;</i></a>
        <a href="<?php echo url('cat/'.$cid,array('sort'=>'hot')); ?>" <?php if($sort == 'hot'): ?>class="active"<?php endif; ?>>销量<i class="layui-icon" style="vertical-align: -2px;">&#xe625;</i></a>
        <a href="<?php echo url('cat/'.$cid,array('sort'=>'price')); ?>" <?php if($sort == 'price'): ?>class="active"<?php endif; ?>>价格<i class="layui-icon" style="vertical-align: -2px;">&#xe625;</i></a>
        <a href="<?php echo url('cat/'.$cid,array('sort'=>'rate')); ?>" <?php if($sort == 'rate'): ?>class="active"<?php endif; ?>>折扣<i class="layui-icon" style="vertical-align: -2px;">&#xe625;</i></a>
        <a href="<?php echo url('cat/'.$cid,array('sort'=>'quan')); ?>" <?php if($sort == 'quan'): ?>class="active"<?php endif; ?>>券额<i class="layui-icon" style="vertical-align: -2px;">&#xe625;</i></a>
      </div>
    </div>
  </div>
</div>

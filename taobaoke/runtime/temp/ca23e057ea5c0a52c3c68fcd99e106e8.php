<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:35:"./template/default/index_index.html";i:1548318442;s:36:"./template/default/index_header.html";i:1506439004;s:37:"./template/default/public_gradeh.html";i:1490864914;s:36:"./template/default/public_goods.html";i:1506701012;s:36:"./template/default/index_footer.html";i:1505706092;}*/ ?>
...
<div class="swiper">
  <div class="layui-main">
    <div class="category">
      <dl>
        <dd><a href="<?php echo url('cat/1'); ?>"><i class="ct-icon ct-icon-nvzhuang"></i>女装<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/2'); ?>"><i class="ct-icon ct-icon-nanzhuang"></i>男装</a></dd>
        <dd><a href="<?php echo url('cat/7'); ?>"><i class="ct-icon ct-icon-xiezi"></i>鞋子<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/8'); ?>"><i class="ct-icon ct-icon-xiangbao"></i>箱包</a></dd>
        <dd><a href="<?php echo url('cat/4'); ?>"><i class="ct-icon ct-icon-muying"></i>母婴<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/5'); ?>"><i class="ct-icon ct-icon-meizhuang"></i>美妆</a></dd>
        <dd><a href="<?php echo url('cat/6'); ?>"><i class="ct-icon ct-icon-jiafang"></i>居家<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/9'); ?>"><i class="ct-icon ct-icon-peishi"></i>配饰</a></dd>
        <dd><a href="<?php echo url('cat/12'); ?>"><i class="ct-icon ct-icon-wenti"></i>文体<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/10'); ?>"><i class="ct-icon ct-icon-meishi"></i>美食</a></dd>
        <dd><a href="<?php echo url('cat/11'); ?>"><i class="ct-icon ct-icon-shuma"></i>电器<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/13'); ?>"><i class="ct-icon ct-icon-jujia"></i>运动</a></dd>
        <dd><a href="<?php echo url('cat/3'); ?>"><i class="ct-icon ct-icon-neiyi"></i>内衣<em class="ct-line"></em></a></dd>
        <dd><a href="<?php echo url('cat/14'); ?>"><i class="ct-icon ct-icon-dianqi"></i>其他</a></dd>
      </dl>
    </div>
    <div class="slide" id="slide">
      <ul>
      <?php if(is_array($BannerList) || $BannerList instanceof \think\Collection || $BannerList instanceof \think\Paginator): $i = 0; $__LIST__ = $BannerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['identity'] == 'index-slide'): ?>
        <li><a href="<?php echo $vo['links']; ?>" target="_blank"><img src="<?php echo $vo['pic']; ?>" alt="<?php echo $vo['title']; ?>" /></a></li>
        <?php endif; endforeach; endif; else: echo "" ;endif; ?>  
      </ul>
    </div>
    <div class="banner">
      <dl>
      <?php if(is_array($BannerList) || $BannerList instanceof \think\Collection || $BannerList instanceof \think\Paginator): $i = 0; $__LIST__ = $BannerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['identity'] == 'index-banner'): ?>
        <dd>
          <a href="<?php echo $vo['links']; ?>" target="_blank">
            <img src="<?php echo $vo['pic']; ?>" alt="<?php echo $vo['title']; ?>" />
          </a>
        </dd>
        <?php endif; endforeach; endif; else: echo "" ;endif; if(is_array($BannerList) || $BannerList instanceof \think\Collection || $BannerList instanceof \think\Paginator): $i = 0; $__LIST__ = $BannerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['identity'] == 'index-banner-last'): ?>
        <dd class="last">
          <a href="<?php echo $vo['links']; ?>" target="_blank">
            <img src="<?php echo $vo['pic']; ?>" alt="<?php echo $vo['title']; ?>" />
          </a>
...
<div class="bread">
  <div class="layui-main">
    <div class="update-time">
      <div class="today">
        <i class="icon">NEW</i>今日新品<span>每天10点上新</span>
      </div>
    </div>
    <ul class="other">
      <li><a href="<?php echo url('cat/1'); ?>" target="_blank"><span>女装专场</span><i class="icon-arrow"></i></a></li>
      <li><a href="<?php echo url('cat/4'); ?>" target="_blank"><span>母婴专场</span><i class="icon-arrow"></i></a></li>
      <li><a href="<?php echo url('cat/6'); ?>" target="_blank"><span>居家专场</span><i class="icon-arrow"></i></a></li>
      <li class="active"><a href="/" target="_blank"><span>全部商品</span><i class="icon-arrow"></i></a></li>
    </ul>
  </div>  
</div>
<div class="goods-list">
  <div class="layui-main">
    <ul class="list-main">
      <?php if(is_array($SettopGoodsList) || $SettopGoodsList instanceof \think\Collection || $SettopGoodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $SettopGoodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <li>
          <div class="goods-main">
            <div class="pic">
              <a href="<?php echo url('dtl/'.$vo['id']); ?>" target="_blank">
                <img class="lazy" data-original="<?php echo $vo['pic']; ?>" alt="<?php echo $vo['title']; ?>">                                           
              </a>
      ...
      <?php endforeach; endif; else: echo "" ;endif; if(is_array($GoodsList) || $GoodsList instanceof \think\Collection || $GoodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $GoodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
  <li>
    <div class="goods-main">
      <div class="pic">
        <a href="<?php echo url('dtl/'.$vo['id']); ?>" target="_blank">

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./application/admin\view\category_index.html";i:1503471648;s:42:"./application/admin\view\index_header.html";i:1493194503;s:42:"./application/admin\view\index_footer.html";i:1529044280;}*/ ?>
<!DOCTYPE html>
<html>
<head>  
<meta charset="utf-8">
...
<div class="fly-panel fly-panel-user">
  <div class="tpt-admin">
    <div class="tpt-btn">
      <a href="<?php echo url('category/add'); ?>" class="layui-btn"><i class="layui-icon">&#xe608;</i> 添加分类</a>
    </div>
    <form method="post">
      <table width="100%">
        <tr>
        ...
        <tr>
          ...
          <td style="padding-left: 20px;">__INDEX__/cat/<?php echo $vo['id']; ?>.html</td>
...
function changeopen(o){
  ...
  $.ajax({
    ...
    dataType:"json",
      data:{change:change},
    url:"<?php echo url('category/changeopen'); ?>",

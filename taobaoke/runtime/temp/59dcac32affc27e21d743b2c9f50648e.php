<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:34:"./template/default/jump_index.html";i:1504883486;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $Goods['title']; ?> - <?php echo config('web.WEB_TIT'); ?></title>
...
<div style="visibility:hidden;" >
 <a data-type="0" biz-itemid="<?php echo $Goods['numIid']; ?>" data-style="2"  data-tmpl="230x312" style="visibility:hidden;"></a>
</div>
...
var itemUrl = 'http://detail.tmall.com/item.htm?id=<?php echo $Goods['numIid']; ?>';
var url='';
var timer;
function get_et(){
  var s = new Date(),
...
var tl = '230x45';
var rd = '1';
var ct = encodeURIComponent('itemid=<?php echo $Goods['numIid']; ?>');
var st = '2';
...
<else />
<script language="javascript">var iurl="<?php echo $Goods['clickUrl']; ?>";document.write("<meta http-equiv=\"refresh\" content=\"0;url="+iurl+"\" />");</script>
</if>
</body>
</html>

<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:33:"./template/default/index_dtl.html";i:1504154985;s:36:"./template/default/index_header.html";i:1506439004;s:37:"./template/default/public_gradeh.html";i:1490864914;s:36:"./template/default/public_goods.html";i:1506701012;s:36:"./template/default/index_footer.html";i:1505706092;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php echo $Goods['title']; ?> - <?php echo config('web.WEB_AUT'); ?></title>
...
<link rel="stylesheet" href="__ADMIN__/share/dist/css/share.min.css">
<div class="filter">
    ...
    <div class="layui-main">
      <div class="subnav-main">
        <ul>
          ...
          <li><a href="<?php echo url('cat/'.$vo['id']); ?>" <?php if($Category['id'] == $vo['id']): ?>class="active"<?php endif; ?>><?php echo $vo['name']; ?></a></li>  
...
<div class="place-explain">
  <div class="layui-main">
  您的位置：<?php if(config('web.WEB_URL') == 1): ?><a href="__ROOT__/cat/<?php echo $Category['id']; ?>.html"><?php else: ?><a href="__INDEX__/cat/<?php echo $Category['id']; ?>.html"><?php endif; ?><?php echo $Category['name']; ?></a> > <?php echo $Goods['title']; ?>
  </div>
</div>
<div class="detail">
  <div class="layui-main">
    <div class="goods-pic"><img src="<?php echo $Goods['pic']; ?>" alt="<?php echo $Goods['title']; ?>"></div>
    <div class="goods-info">
      <h1 class="title"><?php echo $Goods['title']; ?></h1>
      <p class="description"><?php echo $Goods['description']; ?></p>
      <div class="price">
        <div class="coupon-price">
          <span style="font-size: 14px;">券后价<b style="font-size: 30px; font-weight: bold;"><i>￥</i><?php echo $Goods['couponPrice']; ?></b></span>
        </div>
        <div class="original-price">
          <span style="font-size: 14px;">原价<b style="font-family: Arial"><i>￥</i><?php echo $Goods['price']; ?></b></span>
        </div>
        <div class="volume">
          <span style="font-size: 14px;">销量<b style="font-size: 14px;"><?php echo $Goods['volume']; ?></b></span>
        </div>
      </div>
      <div class="quan">
        <a href="<?php echo url('jump/index'); ?>?id=<?php echo $Goods['id']; ?>" target="_blank" rel="nofollow"><em>￥</em><?php echo $Goods['couponAmount']; ?></a>
      </div>
      <div class="trans">
        <a href="<?php echo url('jump/index'); ?>?id=<?php echo $Goods['id']; ?>" class="layui-btn" target="_blank" rel="nofollow"><i class="layui-icon">&#xe698;</i> 立即前往购买</a>
        <div class="social-share" data-url="<?php echo config('web.WEB_COM'); ?><?php echo url('jump/index'); ?>?id=<?php echo $Goods['id']; ?>" data-source="<?php echo config('web.WEB_COM'); ?>" data-title="<?php echo $Goods['title']; ?>" data-description="<?php echo $Goods['description']; ?>" data-image="<?php echo $Goods['pic']; ?>" data-disabled="diandian" style="float: right;"></div>
      </div>
    </div>
  </div>  
</div>
...
<script src="__ADMIN__/share/dist/js/jquery.share.min.js"></script>

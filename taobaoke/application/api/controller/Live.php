...
/*        $req->setQ($ks);*/
        ...
        if(isset($resp['code'])){
         return json_encode(array("code"=>404,"message"=>"采集器接口错误","success"=>false,"data"=>"NULL"));
        }
        if(!isset($resp['results'])){
             return json_encode(array("code"=>404,"message"=>"采集器接口错","success"=>false,"data"=>"NULL"));
        }
